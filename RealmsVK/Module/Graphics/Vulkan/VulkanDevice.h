...
namespace rlms {
	...
	public:
		...
		*/
		VulkanDevice (VkPhysicalDevice physicalDevice, VulkanQueues*& queues);
		/**
		* Default destructor
		*
		...
		*/
		void queryQueueFamilyIndex (VkSurfaceKHR surface);
		...
		*/
		void copyBuffer (VulkanBuffer* src, VulkanBuffer* dst, VkCommandPool pool, VkQueue queue, VkBufferCopy* copyRegion = nullptr);
